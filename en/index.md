...
Access and edit: view or edit any entry from inside the App at any time
Delete: delete individual entries, or use "Reset all data" to remove everything
Opt out of ad tracking: reset your advertising identifier or limit tracking from your OS settings
Revoke Google access: remove Feeling Palette from your Google account's connected apps
Uninstall: deleting the App removes all data stored on your device
